      ...
      <main id="top">
        <section className="hero shell">
          <div className="hero-copy">
            ...
            <p className="hero-lede">Agent LCM captures work from Codex, Cursor, VS Code, Copilot, and Kiro, then makes that history searchable from any of them.</p>
          ...
          <div className="memory-shell" aria-label="Five agent harnesses writing to one local memory">
            <div className="memory-panel">
              ...
              <div className="memory-flow">
                <div className="sources" aria-hidden="true">
                  {[["CX", "Codex", "session_019f"], ["CU", "Cursor", "chat_7c31"], ["VS", "VS Code", "thread_82ab"], ["GH", "Copilot", "run_4e16"], ["KR", "Kiro", "task_b911"]].map(([badge, name, id]) => (
              ...
              <div className="panel-status"><span>5 harnesses connected</span><span>~/.agent-lcm</span></div>
            </div>
          </div>
        </section>

        <section className="compat shell" aria-label="Supported coding agents"><p>Works where you work</p><div><span>Codex</span><span>Cursor</span><span>VS Code</span><span>GitHub Copilot</span><span>Kiro</span></div></section>
        ...
        <section className="why shell" id="why">
          ...
          <div className="feature-list">
            ...
            <article><span>02</span><div><h3>Search across harnesses</h3><p>Find Codex work from Cursor, Copilot work from Kiro, or any other supported combination.</p></div></article>
